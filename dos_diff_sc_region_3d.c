...
int main(){
    ...
    FILE *parti_surf;
    sprintf(parti_surf_FileName,"parti_surf_of_%06u_ens_id_%d_particles_cut_out_dynamics_damping.txt",no_config,TP);
    parti_surf = fopen(parti_surf_FileName,"rb");
    double dummy1, dummy2, dummy3, dummy4;
    unsigned int avail_configs=0, configs, dummy5;
    ...
    //###########################################################################
    double low_sur_contr = 0.e0, high_sur_contr = 0.8e0;
    ...
    sprintf(omega_distribution_FileName,"vibrational_density_from_%.2lf_to_%.2lf_%06u_configs_%d_TP_40_bin_annealed.txt",low_sur_contr,high_sur_contr,load_configs,TP);
    ...
    start_omega = low_omega-0.0001e0;
    end_omega = high_omega+0.0001e0;
